...
public class Fourteen {
    ...
    public static void count(long num){
        int chainLenght = 0;
        long numberWithTheLongestString = 0;
        for (long i = 2; i <= num; i++) {
            ...
            while (j != 1) {
                ...
                if (chainLenght < counter){
                    chainLenght = counter;
                    numberWithTheLongestString = i;
                }
            }//j
        }//i
        System.out.println(chainLenght + " znaków znajduje się w łańcuchu liczby " + numberWithTheLongestString);
    }
